...
declare module "webpack-env" {
    ...
    namespace e {
        var require: __WebpackModuleApi.RequireFunction;
         ...
         */
        var __webpack_chunk_load__: (chunkId: any, callback: (require: (id: string) => any) => void) => void;

        /**
         * Access to the internal object of all modules.
         */
        var __webpack_modules__: any[];
        ...
        var module: __WebpackModuleApi.Module;
    }
